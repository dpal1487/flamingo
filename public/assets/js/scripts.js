...
$(function () {
  ...
  // light light sidebar button setting
  ...
  // light light layout button setting
  ...
  $(".choose-theme li").removeClass("active");
  $(".choose-theme li[title|='white']").addClass("active");
  //set default light or light layout(1=light, 2=light)
  $(".select-layout[value|='1']").prop("checked", true);
  //set default light or light sidebar(1=light, 2=light)
  $(".select-sidebar[value|='2']").prop("checked", true);
