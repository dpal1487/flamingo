    ...
    <div class="row">
      <div class="col-12 col-md-8 col-lg-8">
        <div class="card">
          ...
          <form action="{{url('industry/create')}}" method="post" enctype="multipart/form-data">
          <div class="card-body">
            {{ csrf_field() }}
            <div class="form-group">
              <label for="name">Industry Name</label>
              <input type="text" class="form-control" name="name" id="name" placeholder="Enter industry name"/>
            </div>
            <!--<div class="form-group">-->
